public class Main {
    ...
    public static void main(String arg[]){
        ...
        Trainer player;
        Pokemon playerStartingPokemon = null;
...
//                    trainerAttack(player, chooseRandomPokemon());
                    ...
                    System.out.println("You have encountered a Gym!");
                    System.out.println("You have to face the Gym Leader and beat them to move to the next map!");
